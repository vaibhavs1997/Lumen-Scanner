...
@rem Prefer the project-compatible private JDK installed for Lumen. Android
@rem Studio's bundled Java may be newer than this Gradle version supports.
for /d %%i in ("%USERPROFILE%\.gradle\jdks\lumen-jdk17\jdk-17*") do (
